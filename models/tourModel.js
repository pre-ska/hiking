...
const tourSchema = new mongoose.Schema(
  {
    ...
    startLocation: {
      //11-4 GeoJSON - ovo je doslovno embeded object - ne schemaType options kao u ostalim slucajevima type....itd
      type: {
        //ovo je schemaType options - ugrađeni u GeoJSON objekt - kao i u ostalim slucajevima, ali ovdje jedan level dublje
        type: String,
        default: "Point", // zelim da po defaultu bude point - tocka
        enum: ["Point"], // zeli da samo i prima point kao tip i nista vise
      },
      coordinates: [Number], // ocekujem niz brojeva
      address: String,
      description: String,
    },
    //11-4
...
// //11-5 pre-hook za embedanje user dokumenata u tour dokument (vodica) - NE KORISTIM OVO ...SAMO ZA PRIMJER
