...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1Ijoid29sZndhciIsImEiOiJja2JodXlmZDYwOHlnMzBycHg3MmNydHk2In0.Rs1t63s02skXQhEdzEoT2w";
  var map = new mapboxgl.Map({
    container: "map",
    style: "mapbox://styles/wolfwar/ckbi1hxs311wa1iqhzezm81af",
    scrollZoom: false // center: [19.00103, 45.34914],
    // zoom: 10,
    // interactive: true,
...
var showAlert = function showAlert(type, msg) {
  ...
  hideAlert();
  var markup = "<div class=\"alert alert--".concat(type, "\">").concat(msg, "</>");
  document.getElementsByTagName("body")[0].insertAdjacentHTML("afterbegin", markup);
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"updatedSettings.js":[function(require,module,exports) {
"use strict";
...
var stripe = Stripe("pk_test_x9rPYMlgaj9DsNEzpFpbs9ES00uCUxhLoQ"); //ovo pozivam iz index.js koji dohvati button i stavi listener na njega
...
var reviews = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(reviewsArray, user, tours) {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
...
var logoutButton = document.getElementsByClassName("nav__el--logout")[0];
var userDataForm = document.getElementsByClassName("form-user-data")[0]; //12-23

var userPasswordForm = document.getElementsByClassName("form-user-password")[0]; //12-23

var bookBtn = document.getElementById("book-tour"); //13-15

var signupForm = document.getElementsByClassName("form--signup")[0];
var reviewPage = document.getElementById("reviewPage"); //delegation
...
if (userPasswordForm) {
  userPasswordForm.addEventListener("submit", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var buttonSP, passwordCurrent, password, passwordConfirm;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              buttonSP = document.getElementById("btn--save-password");
              buttonSP.textContent = "Updating..."; // buttonSP.setAttribute("disabled", true);
            ...
            case 9:
              ...
              buttonSP.textContent = "Save password"; // buttonSP.setAttribute("disabled", false);
...
if (bookBtn) {
  bookBtn.addEventListener("click", function (e) {
    e.target.textContent = "Processing ..."; // izvuci tourId iz button dataseta ... svaki - u datasetu je konvertiran u camelcase
...
if (alertmessage) (0, _alert.showAlert)("success", alertMessage, 7); //ext
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "5917" + '/');
